  ...
  <table width="400" border="0" cellpadding="0" cellspacing="0">
    ...
    if (isset($_GET['id'])) {
      ...
      while ($row3 = $result->fetch_assoc()) {
        $id = $row3['product_id']; // Ensure correct column name
  ...
  <table width="400" border="0" cellpadding="0" cellspacing="0" style="color:#000000;"> 
    ...
    if (isset($_GET['id'])) {
      ...
      while ($row3 = $result->fetch_assoc()) {
        ...
        echo '<td><input name="butadd" type="image" value="'.$row3['product_id'].'" src="images/button.png" /></td>'; // Correct value for butadd
        echo '</tr>';
      }
    }
    ?>
